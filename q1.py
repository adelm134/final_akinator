...
yes_img = pygame.image.load('resources/yes_btn.png').convert_alpha()
no_img = pygame.image.load('resources/no_btn.png').convert_alpha()

font = pygame.font.Font('resources/font.ttf', 12)
font1 = pygame.font.Font('resources/font.ttf', 20)
purple = (205,96,144)
